...
if args.zsh:
  print("\033[1;34m=> \033[1;32mMaking ZSH completions directory in $ZDOTDIR/custom_completions...\033[0m")
  os.system("mkdir -vp $ZDOTDIR/custom_completions")
  print("\033[1;34m=> \033[1;32mMoving ZSH compdef files to $ZDOTDIR/custom_completions...\033[0m")
  os.system("cp -v _katti $ZDOTDIR/custom_completions")
  print("\033[1;34m=> \033[1;32mEnsuring $ZDOTDIR/custom_completions is included in $fpath environment variable...\033[0m")
  print("echo 'fpath=($ZDOTDIR/custom_completions $fpath)' >> $ZDOTDIR/.zshrc")
  os.system("echo 'fpath=($ZDOTDIR/custom_completions $fpath)' >> $ZDOTDIR/.zshrc")
  print("autoload -U compinit && compinit' >> $ZDOTDIR/.zshrc")
  os.system("echo 'autoload -U compinit && compinit' >> $ZDOTDIR/.zshrc")
